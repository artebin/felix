...
configure_xfce4_notifyd(){
	printf "Configuring xfce4-notifyd ...\n"
	...
	cp "${FELIX_ROOT}/dotfiles/.config/xfce4/xfconf/xfce-perchannel-xml/${CONFIG_FILE}" "${HOME}/.config/xfce4/xfconf/xfce-perchannel-xml/${CONFIG_FILE}"
