...
configure_gtk2(){
	...
	backup_by_rename_if_exists_and_copy_replacement "${HOME}/.gtkrc-2.0" "${FELIX_ROOT}/dotfiles/.gtkrc-2.0"
...
configure_gtk3(){
	...
	backup_by_rename_if_exists_and_copy_replacement "${HOME}/.config/gtk-3.0/settings.ini" "${FELIX_ROOT}/dotfiles/.config/gtk-3.0/settings.ini"
	...
	cp "${FELIX_ROOT}/dotfiles/.config/gtk-3.0/gtk.css" "${HOME}/.config/gtk-3.0/gtk.css"
